...
export const cultivarRegistry: CultivarRecord[] = [
  ...
  // ---- Added July 2026 (post-audit; also wired into the legacy app via data/cultivarConfig.ts) ----
  {
    id: 'dunsmuir',
    name: 'Dunsmuir',
    emoji: '🚂',
    ...
    imageDir: 'dunsmuir',
    contentDir: 'dunsmuir',
    chart: { csv: 'dunsmuir', yieldAxisMax: 900, firmnessRange: [1, 1.4] },
    comparison: {
      options: ['adelanto', 'belvedere', 'fronteras'],
      defaultComparison: null,
      mobileFixed: 'adelanto',
    },
  },
  {
    id: 'elcano',
    ...
    imageDir: 'elcano',
    contentDir: 'elcano',
    chart: { csv: 'elcano', yieldAxisMax: 600, firmnessRange: [0.9, 1.3] },
    comparison: {
      options: ['adelanto', 'belvedere', 'castaic'],
      defaultComparison: null,
      mobileFixed: null,
    },
  },
